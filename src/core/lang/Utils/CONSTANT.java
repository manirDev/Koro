...
public  class CONSTANT {
    ...
    public static char CARRIAGE_RETURN = '\0';
    public static char STRING_QUOTE = '\0';
    public static char FRACTIONAL_PERIOD = '_';
    public static char UNDER_SCORE= '_';
    public static char LOWER_CASE_CHAR_LOWER_BOUND = 'a';
    public static char LOWER_CASE_CHAR_UPPER_BOUND = 'z';
    public static char UPPER_CASE_CHAR_LOWER_BOUND = 'A';
